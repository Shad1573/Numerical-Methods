# -*- coding: utf-8 -*-
"""Differentiation: Forward, Backward, And Central and Richardson Extrapolation_Assignment5.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ljBxuIm0sVECW74SDlCeUh2e26Lf0jJ9
...
hs = np.array([3.5, 0.55, 0.3, .17, 0.1, 0.055, 0.03, 0.017, 0.01])
err = error_1(p, p_prime, hs, 6.0)
e1, e2 = error_2(p, hs, 6.0)
