# -*- coding: utf-8 -*-
"""Hermite Interpolation and Polynomial Interpolation Using Newton's Divided Difference Form_Assignment4.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1KpNL6t4PZlCMXregIkSHXEMu6LUU4kij
...
Suppose, you have three nodes (-0.7, 2.13), (0, 2.56), (0.7, 2.99). Using Newton's Divided Difference method, print out the value of the interpolating polynomial at x = 11.
...
data_x = np.array([-0.7, 0, 0.7])
data_y = np.array([2.13, 2.56, 2.99])
differences = calc_div_diff(list(data_x), list(data_y))
p = Newtons_Divided_Differences(list(differences))
test_x = [11]
test_y = p(test_x)
...
Using Hermit basis, print out the interpolating polynomial and find the value at x = [0.45, 0.65, 0.85].
