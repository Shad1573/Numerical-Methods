# -*- coding: utf-8 -*-
"""Polynomial Root Finding Using Bisection Method and Fixed Point Iteration_Assignment6.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1B3yTbbsnSzsKN9KsAFj2BDlJ-7MeEPnM
...
Consider the following function: f(x) = x^3 + x^2 − 14x − 14.

Use interval bisection method to find the root, x∗ of f(x), on the interval [−3, 4], where the error bound, δ = 10^-2.
"""

f = Polynomial([-14, -14, 1, 1])
a = -3
b = 4
m = (a + b) / 2
e = 1e-2
